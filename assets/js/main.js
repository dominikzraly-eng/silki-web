...
(function () {
  ...
  function initCatalogFilters(container) {
    ...
    function syncUrl(lb, sb, wb, showSold) {
    ...
    function applyFilters(writeUrl) {
      ...
      if (writeUrl !== false) syncUrl(lb, sb, wb, showSold);
    }
    function readUrl() {
    ...
    [fLength, fShade, fWeight].forEach(function (s) { if (s) s.addEventListener("change", function () { applyFilters(true); }); });
